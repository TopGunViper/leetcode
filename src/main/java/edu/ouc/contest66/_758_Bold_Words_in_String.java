...
public class _758_Bold_Words_in_String {
    ...
    public static void main(String args[]) {
        ...
        Assert.check(tester.boldWords(words, S).equals("a<b>abc</b>d"));

        String[] words2 = {"ab", "cb"};
        String S2 = "aabcd";

        Assert.check(tester.boldWords(words2, S2).equals("a<b>ab</b>cd"));

        String[] words3 = {"ccb", "b", "d", "cba", "dc"};
        String S3 = "eeaadadadc";
        Assert.check(tester.boldWords(words3, S3).equals("eeaa<b>d</b>a<b>d</b>a<b>dc</b>"));

        String[] words4 = {"e", "cab", "de", "cc", "db"};
        String S4 = "cbccceeead";
        Assert.check(tester.boldWords(words4, S4).equals("cb<b>ccceee</b>ad"));

        String[] words5 = {"ab", "ab"};
        String S5 = "abab";

        Assert.check(tester.boldWords(words5, S5).equals("<b>abab</b>"));

        String[] words6 = {"a", "a"};
        String S6 = "a";

        Assert.check(tester.boldWords(words6, S6).equals("<b>a</b>"));
